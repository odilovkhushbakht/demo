...
use App\Modules\Notifications\NotificationVacationChildcareLeaveMessage;
use Carbon\Carbon;

class NotificationVacationChildcareLeave
{
    ...
    public function store($vacation): void
    {
        ...
        $message = NotificationVacationChildcareLeaveMessage::generate($vacation);
        ...
        $notification->category_id = NotificationCategoryEnum::VACATION_CHILDCARE_LEAVE_EXPIRY->value;
        ...
        if (Carbon::now()->lte($vacation->end_date)) {
            ...
            (new Notification())->updateOrCreate(
                ...
                [
                    ...
                    'category_id' => NotificationCategoryEnum::VACATION_CHILDCARE_LEAVE_EXPIRY->value,
                ]
    ...
    public function delete($vacation): void
    {
        Notification::where('notificationable_type', 'ord_vacation')
            ...
            ->where('category_id', NotificationCategoryEnum::VACATION_CHILDCARE_LEAVE_EXPIRY->value)
            ->delete();
    }
}
